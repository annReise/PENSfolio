    ...
    <header class="bg-white border-b sticky top-0 z-50">
        <nav class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <ul class="flex gap-8 font-medium items-center">
                ...
                <li>
                    <a href="/dashboard"
                       class="{{ request()->is('dashboard') ? 'text-blue-900 font-semibold' : 'text-gray-700 hover:text-blue-900' }}">
                        Dashboard
                    </a>
                </li>
                ...
                <li>
                    <a href="/portfolio"
                       class="{{ request()->is('portfolio*') ? 'text-blue-900 font-semibold' : 'text-gray-700 hover:text-blue-900' }}">
                        Portofolio
                    </a>
                </li>
                ...
                <li>
                    <a href="/skills"
                       class="{{ request()->is('skills*') ? 'text-blue-900 font-semibold' : 'text-gray-700 hover:text-blue-900' }}">
                        Keahlian
                    </a>
                </li>
                ...
                <li>
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <button @click="open = !open" class="flex items-center gap-2">
                            <img src="{{ $avatarNav }}"
                                 class="w-9 h-9 rounded-full object-cover" alt="Me">
                        ...
                        <div x-show="open"
                             ...
                             class="absolute right-0 mt-2 w-48 bg-white shadow-md border rounded-md py-2 z-50"
                             x-transition>
